...
print(f"steps\t{'RSS(MB)':8}\t{'PSS(MB)':8}\t{'USS(MB)':8}\t{'VMS(MB)':8}\t{'Total CPU Usage(%)':8}")
steps = 1
RUBY = "ruby"
rss = 0
pss = 0
...
while steps <= args.steps:
    ...
    print(f"{steps}\t{rss /1024/1024 :8}\t{pss /1024/1024 :8}\t{uss /1024/1024 :8}\t{vms /1024/1024 :8}\t{cpu:8}")
    steps = steps + 1
    rss = 0
    pss = 0
    uss = 0
